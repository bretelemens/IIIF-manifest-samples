# Beeld
## use case
•	Digitale Toegang tot alle beelden van één collectiestuk
...
* Manifest/labe bevat de titel van het collectiestuk. De titel kan in verschillende talen getoond worden. Elk titel heeft een taalcode. Deze titels worden in de viewer prominent getoond ij het beeld
* 
