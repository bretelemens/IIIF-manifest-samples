...
from a legacy IIIF v2 source.json for EHC_e772.
...
Source:
    Madame de Pompadour / de Goncourt, Edmond; de Goncourt, Jules
    Nouvelle édition, revue et augmentée de lettres et documents inédits
    Paris : G. Charpentier, éditeur, 1881. 491 p.
    Erfgoedbibliotheek Hendrik Conscience, Antwerpen — e 772 [C3-956 f]
    Catalogue record: https://go.wander.be/record/opacehc/c:lvd:720281
"""
...
BASE_URI = (
    "https://bretelemens.github.io/IIIF-manifest-samples/003-beeld/EHC_e772"
)

METADATA = [
    {
        "label": {"nl": ["Inventarisnummer"]},
        "value": {"nl": ["e 772 [C3-956 f]"]},
    },
    {
        "label": {"nl": ["Titel"]},
        "value": {"fr": ["Madame de Pompadour"]},
    },
    {
        "label": {"nl": ["Auteur"]},
        "value": {"nl": ["de Goncourt, Edmond; de Goncourt, Jules"]},
    },
    {
        "label": {"nl": ["Editie"]},
        "value": {"fr": ["Nouvelle édition, revue et augmentée de lettres et documents inédits"]},
    },
    {
        "label": {"nl": ["Uitgave"]},
        "value": {"fr": ["Paris : G. Charpentier, éditeur, 1881"]},
    },
    {
        "label": {"nl": ["Datering"]},
        "value": {"nl": ["1881"]},
    ...
    {
        "label": {"nl": ["Collectie"]},
        "value": {"nl": ["Collectie Georges Eekhoud Kabinet"]},
    },
    {
        "label": {"nl": ["Permalink"]},
        "value": {
            "nl": [
                '<a href="https://go.wander.be/record/opacehc/c:lvd:720281">'
                "https://go.wander.be/record/opacehc/c:lvd:720281</a>"
            ]
        },
    },
]
...
def convert_canvas(src_canvas: dict, index: int) -> dict:
    ...
    # Keep only XML (ALTO) renderings, drop TIFF and TXT
    rendering = []
...
def build_manifest(source_path: Path) -> dict:
    ...
    manifest = {
                ...
                "homepage": [
                    {
                        ...
                        "type": "Text",
                        "label": {
                            "nl": ["Homepage Erfgoedbibliotheek Hendrik Conscience"]
                        },
                        "format": "text/html",
                    }
                ],
        ...
        "requiredStatement": {
            ...
            "value": {
                "nl": [
                    "e 772, Collectie Stad Antwerpen, "
        ...
        "seeAlso": [
            {
                "id": "https://go.wander.be/record/opacehc/c:lvd:720281",
                "type": "Dataset",
                "label": {
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert legacy IIIF v2 source.json to IIIF v3 manifest.json for EHC_e772"
    )
