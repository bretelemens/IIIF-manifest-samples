...
<xsl:stylesheet version="1.0"
  ...
  <!--
    transform_word.xsl: ALTO v4 to IIIF v3 AnnotationPage, one String element (word) per annotation.
    Run via: python scripts/alto_to_ocr.py with flag: xsl scripts/transform_word.xsl
